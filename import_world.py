...
The 'dropped:' map in 'partcad.yaml' beside this file is what words each counter
for a reader of `pc info`. See docs/source/simulation.rst in PartCAD itself.
"""
...
# against: 'primitive_shapes' builds the box, cylinder and sphere a world names
